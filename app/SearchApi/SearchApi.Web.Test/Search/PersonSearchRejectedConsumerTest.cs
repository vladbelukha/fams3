   ...
   public  class PersonSearchRejectedConsumerTest
    {
        ...
        public void Should_send_the_initial_message_to_the_consumer()
        {
            ...
            _searchApiNotifierMock.Verify(x => x.NotifyEventAsync(It.Is<string>(x => x == _requestKey), It.IsAny<PersonSearchRejected>(), It.IsAny<string>(), It.IsAny<CancellationToken>()), Times.Exactly(1));
        }
    }
}
