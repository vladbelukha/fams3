...
namespace SearchAdapter.Sample.SearchRequest
{
    ...
    public class PersonSearchCompletedJCASample : PersonSearchCompletedJCA
    {
    ...
    public static class FakePersonBuilder
    {
        ...
        public static PersonSearchCompletedJCA BuildFakePersonSearchJCACompleted(Guid searchrequestId, string SearchRequestKey, string firstname, string lastname, DateTime dob, ProviderProfile _profile)
        {

            return new PersonSearchCompletedJCASample()
            {
                Message = "We performed search and did not like it",
                Status = SearchStatus.Succeeded,
                ProviderProfile = _profile,
